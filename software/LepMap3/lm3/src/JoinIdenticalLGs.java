...
//Errorcodes 7xx
public class JoinIdenticalLGs {
	public static void main(String args[])
	{
		if (args.length == 0)
			Error.error(601);
		String extraParameters = "";
		System.out.print("#java JoinLGs ");
		...
		if (!pp.init(extraParameters))
			Error.error(601);
		pp.warning(new String[]{"data", "lodLimit", "informativeMask", "femaleTheta", "maleTheta", "sizeLimit", "theta", "alleleLimit", "lod3Mode", "map"});
		...
		sc.joinLGs(lodLimit, map, Integer.parseInt(pp.getValueAsString("sizeLimit", "0")));
