rule calculate_distances:
    ...
    shell:
        ...
        zcat {input.data_call} | java -cp software/LepMap3 OrderMarkers2 evaluateOrder={input.lg} data=- {params.dist_method} numThreads={threads} improveOrder=0 sexAveraged=1 &> {output.sex_averagedtmp}
        ...
        zcat {input.data_call} | java -cp software/LepMap3 OrderMarkers2 evaluateOrder={input.lg} data=- {params.dist_method} numThreads={threads} calculateIntervals={output.intervals} > {log.intervals} 2>&1
        """