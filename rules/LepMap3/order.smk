rule order_markers:
    ...
    shell:
        """
        zcat {input.datacall} | java -cp $CONDA_PREFIX/bin/ OrderMarkers2 chromosome={params.chrom} map={input.filt_map} {params.extra} data=- numThreads={threads} &> {output.runlog}
